...
<div class="container px-4 py-5">
    ...
    <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
      <div class="d-flex flex-column align-items-start gap-2">
        ...
        <a href="#" class="btn btn-primary btn-lg"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Botón principal</font></font></a>
      </div>
      <div class="row row-cols-1 row-cols-sm-2 g-4">
        <div class="d-flex flex-column gap-2">
          <div class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="100px" height="30" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
        ...
        <div class="d-flex flex-column gap-2">
          <div class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="100px" height="30" fill="currentColor" class="bi bi-box2-heart" viewBox="0 0 16 16">
        ...
        <div class="d-flex flex-column gap-2">
          ...
          <h4 class="fw-semibold mb-0"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Título destacado</font></font></h4>
          <p class="text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Párrafo de texto debajo del encabezado para explicar el encabezado.</font></font></p>
        </div>
      </div>
    </div>
  </div>