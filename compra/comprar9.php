...
<html>
  <head>
    ...
    <title>Hilos Red leaf Catalogo #9 HinsoNylon</title>
      ...
      <section class = "banner-wrapper "style="text-align:left;">
        <nav class = "navbar">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="39" height="40" fill="currentColor" class="bi bi-bookmark-check-fill" viewBox="0 0 16 16">
            ...
            <span>Hilos Red leaf Catalogo #9</span>        
          </div>
        </nav>
          ...
          <div class = "banner-left">
            ...
            <div class = "color-content">
              ...
              <div class = "color-groups">
                <a href="https://walink.co/617bf8"><div class = "color color-004" data-title="Ref-004"></div></i></a>
                <i><div class = "color color-005" data-title="Ref-005"></div></i>
                <i><div class = "color color-011" data-title="Ref-011"></div></i>
                <i><div class = "color color-012" data-title="Ref-012"></div></i>
                <i><div class = "color color-311" data-title="Ref-311"></div></i>
                <i><div class = "color color-312" data-title="Ref-312"></div></i>
                <i><div class = "color color-055" data-title="Ref-055"></div></i>
                <i><div class = "color color-058" data-title="Ref-058"></div></i>
                <i><div class = "color color-417" data-title="Ref-417"></div></i>
              </div>
              <div class = "color-groups2">
                <i><div class = "color color-550" data-title="Ref-550"></div></i>
              </div>
            </div>
          </div>
        </div>
