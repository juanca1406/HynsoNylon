...
<html>
  <head>
    ...
    <title>Hilos Red leaf Catalogo #3 HinsoNylon</title>
      ...
      <section class = "banner-wrapper "style="text-align:left;">
        <nav class = "navbar">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="39" height="40" fill="currentColor" class="bi bi-bookmark-check-fill" viewBox="0 0 16 16">
            ...
            <span>Hilos Red leaf Catalogo #3</span>        
          </div>
        </nav>
          ...
          <div class = "banner-left">
            ...
            <div class = "color-content">
              ...
              <div class = "color-groups">
                <a href="https://walink.co/617bf8"><div class = "color color-162" data-title="Ref-162"></div></i></a>
                <i><div class = "color color-166" data-title="Ref-166"></div></i>
                <i><div class = "color color-678" data-title="Ref-678"></div></i>
                <i><div class = "color color-679" data-title="Ref-679"></div></i>
                <i><div class = "color color-675" data-title="Ref-675"></div></i>
                <i><div class = "color color-551" data-title="Ref-551"></div></i>
                <i><div class = "color color-553" data-title="Ref-553"></div></i>
                <i><div class = "color color-552" data-title="Ref-552"></div></i>
                <i><div class = "color color-154" data-title="Ref-154"></div></i>
              </div>
              <div class = "color-groups2">
                <i><div class = "color color-152" data-title="Ref-152"></div></i>
                <i><div class = "color color-149" data-title="Ref-149"></div></i>
                <i><div class = "color color-150" data-title="Ref-150"></div></i>
                <i><div class = "color color-151" data-title="Ref-151"></div></i>
                <i><div class = "color color-153" data-title="Ref-153"></div></i>
                <i><div class = "color color-617" data-title="Ref-617"></div></i>
              </div>
            </div>
          </div>
        </div>
