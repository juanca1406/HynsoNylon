...
<html>
  <head>
    ...
    <title>Hilos Red leaf Catalogo #7 HinsoNylon</title>
  ...
  <img src = "../img/tirilla7.png">
      ...
      <section class = "banner-wrapper "style="text-align:left;">
        <nav class = "navbar">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="39" height="40" fill="currentColor" class="bi bi-bookmark-check-fill" viewBox="0 0 16 16">
            ...
            <span>Hilos Red leaf Catalogo #7</span>        
          </div>
        </nav>
          ...
          <div class = "banner-left">
            ...
            <div class = "color-content">
              ...
              <div class = "color-groups">
                <a href="https://walink.co/617bf8"><div class = "color color-301" data-title="Ref-301"></div></i></a>
                <i><div class = "color color-091" data-title="Ref-091"></div></i>
                <i><div class = "color color-307" data-title="Ref-307"></div></i>
                <i><div class = "color color-305" data-title="Ref-305"></div></i>
                <i><div class = "color color-636" data-title="Ref-636"></div></i>
                <i><div class = "color color-637" data-title="Ref-637"></div></i>
                <i><div class = "color color-6393" data-title="Ref-6393"></div></i>
                <i><div class = "color color-6428" data-title="Ref-6428"></div></i>
                <i><div class = "color color-7224" data-title="Ref-7224"></div></i>
              </div>
              <div class = "color-groups2">
                <i><div class = "color color-639" data-title="Ref-639"></div></i>
                <i><div class = "color color-638" data-title="Ref-638"></div></i>
                <i><div class = "color color-009" data-title="Ref-009"></div></i>
                <i><div class = "color color-309" data-title="Ref-309"></div></i>
                <i><div class = "color color-302" data-title="Ref-302"></div></i>
                <i><div class = "color color-4247" data-title="Ref-4247"></div></i>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
      <div class="d-flex flex-column align-items-start gap-2">
        ...
        <p class="text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Numero De Telefono: 604 2918370  </font><br><font style="vertical-align: inherit;">Numero De Celular: 3012701172 </font></font></p>
        <a href="https://walink.co/617bf8">
        <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="30px" fill="green" class="bi bi-whatsapp" viewBox="0 0 16 16">
          <path d="M13.601 2.326A7.854 7.854 0 0 0 7.994 0C3.627 0 .068 3.558.064 7.926c0 1.399.366 2.76 1.057 3.965L0 16l4.204-1.102a7.933 7.933 0 0 0 3.79.965h.004c4.368 0 7.926-3.558 7.93-7.93A7.898 7.898 0 0 0 13.6 2.326zM7.994 14.521a6.573 6.573 0 0 1-3.356-.92l-.24-.144-2.494.654.666-2.433-.156-.251a6.56 6.56 0 0 1-1.007-3.505c0-3.626 2.957-6.584 6.591-6.584a6.56 6.56 0 0 1 4.66 1.931 6.557 6.557 0 0 1 1.928 4.66c-.004 3.639-2.961 6.592-6.592 6.592zm3.615-4.934c-.197-.099-1.17-.578-1.353-.646-.182-.065-.315-.099-.445.099-.133.197-.513.646-.627.775-.114.133-.232.148-.43.05-.197-.1-.836-.308-1.592-.985-.59-.525-.985-1.175-1.103-1.372-.114-.198-.011-.304.088-.403.087-.088.197-.232.296-.346.1-.114.133-.198.198-.33.065-.134.034-.248-.015-.347-.05-.099-.445-1.076-.612-1.47-.16-.389-.323-.335-.445-.34-.114-.007-.247-.007-.38-.007a.729.729 0 0 0-.529.247c-.182.198-.691.677-.691 1.654 0 .977.71 1.916.81 2.049.098.133 1.394 2.132 3.383 2.992.47.205.84.326 1.129.418.475.152.904.129 1.246.08.38-.058 1.171-.48 1.338-.943.164-.464.164-.86.114-.943-.049-.084-.182-.133-.38-.232z"/>
        </svg>
        </a>
        <a href="tienda.php" class="btn btn-primary btn-md"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nuestra Ubicación</font></font></a>
      </div>
      <div class="row row-cols-1 row-cols-sm-2 g-4">
        ...
        <div class="d-flex flex-column gap-2">
          ...
          <p class="text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Distribuidores autorizados de las mejores marcas de hilos y nylon.</font></font></p>
        </div>
      </div>
    </div>
    <footer class="">
