...
<html>
  <head>
    ...
    <title>Hilos Red leaf Catalogo #2 HinsoNylon</title>
      ...
      <section class = "banner-wrapper "style="text-align:left;">
        <nav class = "navbar">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="39" height="40" fill="currentColor" class="bi bi-bookmark-check-fill" viewBox="0 0 16 16">
            ...
            <span>Hilos Red leaf Catalogo #2</span>        
          </div>
        </nav>
          ...
          <div class = "banner-left">
            ...
            <div class = "color-content">
              ...
              <div class = "color-groups">
                <a href="https://walink.co/617bf8"><div class = "color color-051" data-title="Ref-051"></div></i></a>
                <i><div class = "color color-057" data-title="Ref-057"></div></i>
                <i><div class = "color color-056" data-title="Ref-056"></div></i>
                <i><div class = "color color-068" data-title="Ref-068"></div></i>
                <i><div class = "color color-066" data-title="Ref-066"></div></i>
                <i><div class = "color color-064" data-title="Ref-064"></div></i>
                <i><div class = "color color-072" data-title="Ref-072"></div></i>
                <i><div class = "color color-069" data-title="Ref-069"></div></i>
                <i><div class = "color color-071" data-title="Ref-071"></div></i>
              </div>
              <div class = "color-groups2">
                <i><div class = "color color-180" data-title="Ref-180"></div></i>
                <i><div class = "color color-065" data-title="Ref-065"></div></i>
                <i><div class = "color color-070" data-title="Ref-070"></div></i>
                <i><div class = "color color-067" data-title="Ref-067"></div></i>
                <i><div class = "color color-185" data-title="Ref-185"></div></i>
                <i><div class = "color color-385" data-title="Ref-385"></div></i>
              </div>
            </div>
          </div>
        </div>
