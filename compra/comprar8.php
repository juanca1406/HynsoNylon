...
<html>
  <head>
    ...
    <title>Hilos Red leaf Catalogo #8 HinsoNylon</title>
      ...
      <section class = "banner-wrapper "style="text-align:left;">
        <nav class = "navbar">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="39" height="40" fill="currentColor" class="bi bi-bookmark-check-fill" viewBox="0 0 16 16">
            ...
            <span>Hilos Red leaf Catalogo #8</span>        
          </div>
        </nav>
          ...
          <div class = "banner-left">
            ...
            <div class = "color-content">
              ...
              <div class = "color-groups">
                <a href="https://walink.co/617bf8"><div class = "color color-310" data-title="Ref-310"></div></i></a>
                <i><div class = "color color-1034" data-title="Ref-1034"></div></i>
                <i><div class = "color color-240" data-title="Ref-240"></div></i>
                <i><div class = "color color-931" data-title="Ref-931"></div></i>
                <i><div class = "color color-936" data-title="Ref-936"></div></i>
                <i><div class = "color color-937" data-title="Ref-937"></div></i>
                <i><div class = "color color-495" data-title="Ref-495"></div></i>
                <i><div class = "color color-334" data-title="Ref-334"></div></i>
                <i><div class = "color color-333" data-title="Ref-333"></div></i>
              </div>
              <div class = "color-groups2">
                <i><div class = "color color-254" data-title="Ref-254"></div></i>
                <i><div class = "color color-257" data-title="Ref-257"></div></i>
                <i><div class = "color color-255" data-title="Ref-255"></div></i>
                <i><div class = "color color-256" data-title="Ref-256"></div></i>
                <i><div class = "color color-261" data-title="Ref-261"></div></i>
                <i><div class = "color color-100" data-title="Ref-100"></div></i>
              </div>
            </div>
          </div>
        </div>
