...
<html>
  <head>
    ...
    <title>Hilos Red leaf Catalogo #4 HinsoNylon</title>
      ...
      <section class = "banner-wrapper "style="text-align:left;">
        <nav class = "navbar">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="39" height="40" fill="currentColor" class="bi bi-bookmark-check-fill" viewBox="0 0 16 16">
            ...
            <span>Hilos Red leaf Catalogo #4</span>        
          </div>
        </nav>
          ...
          <div class = "banner-left">
            ...
            <div class = "color-content">
              ...
              <div class = "color-groups">
                <a href="https://walink.co/617bf8"><div class = "color color-410" data-title="Ref-410"></div></i></a>
                <i><div class = "color color-413" data-title="Ref-413"></div></i>
                <i><div class = "color color-414" data-title="Ref-414"></div></i>
                <i><div class = "color color-416" data-title="Ref-416"></div></i>
                <i><div class = "color color-202" data-title="Ref-202"></div></i>
                <i><div class = "color color-238" data-title="Ref-238"></div></i>
                <i><div class = "color color-217" data-title="Ref-217"></div></i>
                <i><div class = "color color-237" data-title="Ref-237"></div></i>
              </div>
              <div class = "color-groups2">
                <i><div class = "color color-220" data-title="Ref-220"></div></i>
                <i><div class = "color color-210" data-title="Ref-210"></div></i>
                <i><div class = "color color-212" data-title="Ref-212"></div></i>
                <i><div class = "color color-211" data-title="Ref-211"></div></i>
                <i><div class = "color color-205" data-title="Ref-205"></div></i>
                <i><div class = "color color-831" data-title="Ref-831"></div></i>
              </div>
            </div>
          </div>
        </div>
