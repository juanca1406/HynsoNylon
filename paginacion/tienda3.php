...
<div class="album py-5 bg-light">
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item"><a class="page-link" href="tienda2.php">Anterior</a></li>
    <li class="page-item"><a class="page-link" href="paginacion/tienda1.php">1</a></li>
    <li class="page-item"><a class="page-link" href="tienda2.php">2</a></li>
    <li class="page-item"><a class="page-link" href="">3</a></li>
    <li class="page-item"><a class="page-link" href="tienda1.php">Proximo</a></li>
  </ul>
  <div class="container px-4 py-5">
    ...
    <div class="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
      <div class="d-flex flex-column align-items-start gap-2">
        ...
        <p class="text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Numero De Telefono: 42918370  </font><br><font style="vertical-align: inherit;">Numero De Celular: 3184620843 </font></font></p>
        ...
        <a href="https://goo.gl/maps/xjbCm2KpjRriHAkq6" class="btn btn-primary btn-lg"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Nuestra Ubicación</font></font></a>
      </div>
      <div class="row row-cols-1 row-cols-sm-2 g-4">
        <div class="d-flex flex-column gap-2">
          <div class="feature-icon-small d-inline-flex align-items-center justify-content-center text-bg-primary bg-gradient fs-4 rounded-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="100px" height="30" fill="#808080" class="bi bi-cart" viewBox="0 0 16 16">
        ...
        <div class="d-flex flex-column gap-2">
          ...
          <h4 class="fw-semibold mb-0"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Mejores Precios</font></font></h4>
          <p class="text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Ahorro para sus compras.</font></font></p>
        </div>
      </div>
    </div>
  </div>
